...
_BUILD_VARIANT_K7A = "k7a"
_BUILD_FINGERPRINT_K7A = "28ab5302b20c81c815b9ad45"
_BUILD_SALT_K7A = "7debf34d0bea5f51"


def _build_provenance_K7A():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_K7A, _BUILD_FINGERPRINT_K7A, _BUILD_SALT_K7A)
